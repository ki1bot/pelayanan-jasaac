...
@section('content')
    <section class="rounded-3xl bg-white p-6 shadow-sm dark:bg-slate-900 md:p-8">
        <h1 class="text-3xl font-bold">Harga Jual AC</h1>
        <p class="mt-3 text-slate-600 dark:text-slate-300">Daftar harga penjualan AC berdasarkan merk.</p>
        ...
        <div class="mt-8 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            ...
            @empty
                <p class="text-slate-500">Data harga jual AC belum tersedia.</p>
            @endforelse
        </div>
    </section>
@endsection
